...
func IntPtr_Set($self, $value)
	dllcall($__Cefau3Dll__, 'none', 'IntPtr_Set', 'ptr', $self, 'int', $value)
endfunc
...
func LongPtr_Set($self, $value)
	dllcall($__Cefau3Dll__, 'none', 'LongPtr_Set', 'ptr', $self, 'long', $value)
endfunc
...
func DoublePtr_Set($self, $value)
	dllcall($__Cefau3Dll__, 'none', 'DoublePtr_Set', 'ptr', $self, 'double', $value)
endfunc

func DoublePtr_Get($self)
	local $ret = dllcall($__Cefau3Dll__, 'double', 'DoublePtr_Set', 'ptr', $self)
	return @error ? 0 : $ret[0]
endfunc
...
Func CefDisplayHandler_Create()
	Local $ret = DllCall($__Cefau3Dll__, 'ptr', 'CefDisplayHandler_Create')
...
Func CefDisplayHandler_OnAddressChange($self, $func)
	...
	DllCall($__Cefau3Dll__, 'none', 'CefDisplayHandler_OnAddressChange', 'ptr', $self, 'ptr', DllCallbackGetPtr($cb))
EndFunc
...
Func CefDisplayHandler_OnTitleChange($self, $func)
	...
	If @error Then Return
	DllCall($__Cefau3Dll__, 'none', 'CefDisplayHandler_OnTitleChange', 'ptr', $self, 'ptr', DllCallbackGetPtr($cb))
EndFunc
...
Func CefDisplayHandler_OnFaviconUrlChange($self, $func)
	...
	If @error Then Return
	DllCall($__Cefau3Dll__, 'none', 'CefDisplayHandler_OnFaviconUrlChange', 'ptr', $self, 'ptr', DllCallbackGetPtr($cb))
EndFunc
...
Func CefDisplayHandler_OnFullscreenModeChange($self, $func)
	...
	If @error Then Return
	DllCall($__Cefau3Dll__, 'none', 'CefDisplayHandler_OnFullscreenModeChange', 'ptr', $self, 'ptr', DllCallbackGetPtr($cb))
EndFunc

Func CefDisplayHandler_OnTooltip($self, $func)
	Local $cb = DllCallbackRegister($func, $__return_OnTooltip, $__params_OnTooltip)
	If @error Then Return
	DllCall($__Cefau3Dll__, 'none', 'CefDisplayHandler_OnTooltip', 'ptr', $self, 'ptr', DllCallbackGetPtr($cb))
EndFunc
...
Func CefDisplayHandler_OnStatusMessage($self, $func)
	...
	If @error Then Return
	DllCall($__Cefau3Dll__, 'none', 'CefDisplayHandler_OnStatusMessage', 'ptr', $self, 'ptr', DllCallbackGetPtr($cb))
EndFunc
...
Func CefDisplayHandler_OnConsoleMessage($self, $func)
	...
	If @error Then Return
	DllCall($__Cefau3Dll__, 'none', 'CefDisplayHandler_OnConsoleMessage', 'ptr', $self, 'ptr', DllCallbackGetPtr($cb))
EndFunc
...
func CefLoadHandler_Create()
	local $ret = dllcall($__Cefau3Dll__, 'ptr', 'CefLoadHandler_Create')
...
func CefLoadHandler_OnLoadingStateChange($self, $func)
    ...
    dllcall($__Cefau3Dll__, 'none', 'CefLoadHandler_OnLoadingStateChange', 'ptr', $self, 'ptr', ($cb) ? dllcallbackgetptr($cb) : null)
endfunc
...
func CefLoadHandler_OnLoadStart($self, $func)
    ...
    if @error then return
    dllcall($__Cefau3Dll__, 'none', 'CefLoadHandler_OnLoadStart', 'ptr', $self, 'ptr', ($cb) ? dllcallbackgetptr($cb) : null)
endfunc

func CefLoadHandler_OnLoadEnd($self, $func)
    local $cb = ($func) ? dllcallbackregister($func, $__return_OnLoadEnd, $__params_OnLoadEnd) : null
    if @error then return
    dllcall($__Cefau3Dll__, 'none', 'CefLoadHandler_OnLoadEnd', 'ptr', $self, 'ptr', ($cb) ? dllcallbackgetptr($cb) : null)
endfunc
...
func CefLoadHandler_OnLoadError($self, $func)
    ...
    if @error then return
    dllcall($__Cefau3Dll__, 'none', 'CefLoadHandler_OnLoadError', 'ptr', $self, 'ptr', ($cb) ? dllcallbackgetptr($cb) : null)
endfunc

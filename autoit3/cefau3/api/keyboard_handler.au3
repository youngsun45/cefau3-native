...
func CefKeyboardHandler_Create()
	local $ret = dllcall($__Cefau3Dll__, 'ptr', 'CefKeyboardHandler_Create')
...
func CefKeyboardHandler_OnPreKeyEvent($self, $func)
	...
	dllcall($__Cefau3Dll__, 'none', 'CefKeyboardHandler_OnPreKeyEvent', 'ptr', $self, 'ptr', dllcallbackgetptr($cb))
endfunc
...
func CefKeyboardHandler_OnKeyEvent($self, $func)
	...
	if @error then return
	dllcall($__Cefau3Dll__, 'none', 'CefKeyboardHandler_OnKeyEvent', 'ptr', $self, 'ptr', dllcallbackgetptr($cb))
endfunc